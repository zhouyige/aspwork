<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminrenew.aspx.cs" Inherits="adminrenew" %>
            ...
            <div class="rightside" style=" height: 600px; right: 0px; position: relative; top: auto; bottom: auto; left: auto;">
                 <div class="rightplane">
                     ...
                     <asp:Button ID="Button1" runat="server" BackColor="Blue" CssClass="botton1" 
                         Font-Names="微软雅黑" Font-Size="10pt" Text="确认" BorderStyle="None" ForeColor="White" />
                     <asp:GridView ID="GridView1" runat="server" CssClass="pagetable1" 
                         Font-Names="微软雅黑" Height="60px" Width="0px" AutoGenerateColumns="False">
                         <Columns>
                             ...
                             <asp:ButtonField HeaderText="确认续借" Text="续借">
                             <ItemStyle Width="100px" Wrap="False" />
                             </asp:ButtonField>
                         </Columns>
