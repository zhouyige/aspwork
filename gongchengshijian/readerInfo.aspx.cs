...
public partial class readerInfo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label12.Text = userinfomodel.Profession;
        Label13.Text = userinfomodel.TelNumber;
        Label14.Text = userinfomodel.UserAccontType.ToString();
    }
    ...
    protected void Label16_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ReaderInfoOP.Delete(userinfomodel.AccontName);
            ReaderInfoOP.Insert(TextBox2.Text.Trim(), userinfomodel.UserPassword
                , userinfomodel.UserAccontType, userinfomodel.TelNumber, userinfomodel.College
    ...
    protected void Label17_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ReaderInfoOP.Delete(userinfomodel.AccontName);
            ReaderInfoOP.Insert(userinfomodel.AccontName, TextBox3.Text.Trim()
                , userinfomodel.UserAccontType, userinfomodel.TelNumber, userinfomodel.College
                , userinfomodel.Address, userinfomodel.Profession, userinfomodel.Name);
            Response.Redirect("readerInfo.aspx");
        }
    ...
    protected void Label18_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ReaderInfoOP.Delete(userinfomodel.AccontName);
            ReaderInfoOP.Insert(userinfomodel.AccontName, userinfomodel.UserPassword
                , userinfomodel.UserAccontType, userinfomodel.TelNumber, TextBox4.Text.Trim()
                , userinfomodel.Address, userinfomodel.Profession, userinfomodel.Name);
            Response.Redirect("readerInfo.aspx");
        }
    ...
    protected void Label19_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ReaderInfoOP.Insert(userinfomodel.AccontName, userinfomodel.UserPassword
                , userinfomodel.UserAccontType, userinfomodel.TelNumber, userinfomodel.College
                , userinfomodel.Address, TextBox5.Text.Trim(), userinfomodel.Name);
            Response.Redirect("readerInfo.aspx");
        }
    ...
    protected void Label20_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ReaderInfoOP.Delete(userinfomodel.AccontName);
            ReaderInfoOP.Insert(userinfomodel.AccontName, userinfomodel.UserPassword
                , userinfomodel.UserAccontType, TextBox6.Text.Trim(), userinfomodel.College
                , userinfomodel.Address, userinfomodel.Profession, userinfomodel.Name);
            Response.Redirect("readerInfo.aspx");
        }
    ...
    protected void Label21_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ReaderInfoOP.Updata(userinfomodel.UserId, userinfomodel.AccontName, userinfomodel.UserPassword
                , Convert.ToInt32(TextBox7.Text.Trim()), userinfomodel.TelNumber, userinfomodel.College
                , userinfomodel.Address, userinfomodel.Profession, userinfomodel.Name);
            Response.Redirect("readerInfo.aspx");
        }
