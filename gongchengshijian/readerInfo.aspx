        ...
        <div>
                ...
                <div class="leftplane1">
                    <div id="u9" class="ax_表格" style="position: absolute; top: 13px; left: 10px">
                        ...
                        <div id="u16" class="ax_单元格" style="cursor: pointer">
                            <img id="u16_img" class="img" src="images/u12.png">
            ...
            <div class="rightside" style=" height: 600px; right: 0px; position: relative; top: auto; bottom: auto; left: auto;">
                 <div class="rightplane">
                     ...
                     <asp:Label ID="Label2" runat="server" Text="借阅证号: " Style="position:absolute; left: 360px;top:100px" Font-Names="微软雅黑" Font-Size="Large"></asp:Label>
                     <asp:Label ID="Label3" runat="server" Text="登陆密码: " Style="position:absolute; left: 360px;top:140px" Font-Names="微软雅黑" Font-Size="Large"></asp:Label>
                     <asp:Label ID="Label4" runat="server" Text="学院: " Style="position:absolute; left: 360px;top:180px" Font-Names="微软雅黑" Font-Size="Large"></asp:Label>
                     <asp:Label ID="Label5" runat="server" Text="专业: " Style="position:absolute; left: 360px;top:220px" Font-Names="微软雅黑" Font-Size="Large"></asp:Label>
                     <asp:Label ID="Label6" runat="server" Text="联系电话: " Style="position:absolute; left: 360px;top:260px" Font-Names="微软雅黑" Font-Size="Large"></asp:Label>
                     <asp:Label ID="Label7" runat="server" Text="用户类型: " Style="position:absolute; left: 360px;top:300px" Font-Names="微软雅黑" Font-Size="Large"></asp:Label>
                     ...
                     <asp:Label ID="Label11" runat="server" Text="Label" Style="position:absolute; left: 410px;top:182px" Font-Names="微软雅黑" Font-Size="Medium"></asp:Label>
                     <asp:Label ID="Label12" runat="server" Text="Label" Style="position:absolute; left: 410px;top:222px" Font-Names="微软雅黑" Font-Size="Medium"></asp:Label>
                     <asp:Label ID="Label13" runat="server" Text="Label" Style="position:absolute; left: 450px;top:262px" Font-Names="微软雅黑" Font-Size="Medium"></asp:Label>
                     <asp:Label ID="Label14" runat="server" Text="Label" Style="position:absolute; left: 450px;top:302px" Font-Names="微软雅黑" Font-Size="Medium"></asp:Label>
                     ...
                     <asp:LinkButton ID="Label18" runat="server" Text="编辑" Style="position:absolute; left: 500px;top:182px;" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" OnClick="Label18_Click"></asp:LinkButton>
                     <asp:LinkButton ID="Label19" runat="server" Text="编辑" Style="position:absolute; left: 500px;top:222px" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" OnClick="Label19_Click"></asp:LinkButton>
                     <asp:LinkButton ID="Label20" runat="server" Text="编辑" Style="position:absolute; left: 550px;top:262px" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" OnClick="Label20_Click"></asp:LinkButton>
                     <asp:LinkButton ID="Label21" runat="server" Text="编辑" Style="position:absolute; left: 550px;top:302px" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" OnClick="Label21_Click"></asp:LinkButton>
                     ...
                     <asp:LinkButton ID="LinkButton5" runat="server" Text="取消" Style="position:absolute; left: 530px;top:182px;" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" Visible="False" OnClick="LinkButton5_Click"></asp:LinkButton>
                     <asp:LinkButton ID="LinkButton6" runat="server" Text="取消" Style="position:absolute; left: 530px;top:222px; height: 19px;" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" Visible="False" OnClick="LinkButton6_Click"></asp:LinkButton>
                     <asp:LinkButton ID="LinkButton7" runat="server" Text="取消" Style="position:absolute; left: 580px;top:262px" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" Visible="False" OnClick="LinkButton7_Click"></asp:LinkButton>
                     <asp:LinkButton ID="LinkButton8" runat="server" Text="取消" Style="position:absolute; left: 580px;top:302px; height: 19px;" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" Visible="False" OnClick="LinkButton8_Click"></asp:LinkButton>
                     ...
                     <asp:TextBox ID="TextBox4" runat="server"  Style="position:absolute; left: 410px;top:180px" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" Visible="False" Width="80px"></asp:TextBox>
                     <asp:TextBox ID="TextBox5" runat="server"  Style="position:absolute; left: 410px;top:220px" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" Visible="False" Width="80px"></asp:TextBox>
                     <asp:TextBox ID="TextBox6" runat="server"  Style="position:absolute; left: 450px;top:260px" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" Visible="False" Width="90px"></asp:TextBox>
                     <asp:TextBox ID="TextBox7" runat="server"  Style="position:absolute; left: 450px;top:300px" Font-Names="微软雅黑" Font-Size="Small" ForeColor="Blue" Visible="False" Width="90px"></asp:TextBox>
