<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminbookreturn.aspx.cs" Inherits="adminbookreturn" %>
            ...
            <div class="rightside" style=" height: 600px; right: 0px; position: relative; top: auto; bottom: auto; left: auto;">
                 <div class="rightplane">
                     ...
                     <asp:GridView ID="GridView1" runat="server" CssClass="pagetable1" 
                         Font-Names="微软雅黑" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowCommand="GridView1_RowCommand" >
                         ...
                         <Columns>
                             ...
                             <asp:ButtonField ShowHeader="True" Text="归还" HeaderText="确认归还" CommandName="确认归还" >
                             <ControlStyle Font-Overline="False" ForeColor="#3399FF" />
                             <ItemStyle BackColor="White" Width="80px" Wrap="False" />
                             </asp:ButtonField>
                         </Columns>
